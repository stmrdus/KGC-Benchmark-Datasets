...
test_data1_1.to_csv((args.folder + "/train/1-1.txt"), sep='\t', header=None, index=None)
test_data1_n.to_csv((args.folder + "/train/1-n.txt"), sep='\t', header=None, index=None)
test_datan_1.to_csv((args.folder + "/train/n-1.txt"), sep='\t', header=None, index=None)
test_datan_n.to_csv((args.folder + "/train/n-n.txt"), sep='\t', header=None, index=None)

test_data_grouped = test_data.groupby(1)

count = 0
for k, gr in test_data_grouped:
    name = "relation_" + str(count)
    gr.to_csv((args.folder + "/train/{}.txt".format(name)), sep='\t', encoding='utf-8', index=False, header=False, mode='a')
    count += 1
...
#test_data1_1.to_csv((args.folder + "/valid/1-1.txt"), sep='\t', header=None, index=None)
test_data1_n.to_csv((args.folder + "/valid/1-n.txt"), sep='\t', header=None, index=None)
test_datan_1.to_csv((args.folder + "/valid/n-1.txt"), sep='\t', header=None, index=None)
test_datan_n.to_csv((args.folder + "/valid/n-n.txt"), sep='\t', header=None, index=None)
